 ...
 * <p>
 * TODO: Create ability, run faster
 */
public class ChickenAbility {
    ...
    public static void attachedMobHatChicken(Player player) {
        if ((player.hasPermission("mobhats.command.mobhat.chicken")) || (player.hasPermission("mobhats.command.mobhat.all"))) {
    ...
    public static void detachedMobHatChicken(Player player) {
