 ...
 * TODO: Create Ability
 */
public class PigZombieAbility {
    private static Pig pig;
    private static PigZombie pigZombie;
    ...
    public static void attachedMobHatPigZombie(Player player) {
        if ((player.hasPermission("mobhats.command.mobhat.pigman")) || (player.hasPermission("mobhats.command.mobhat.all"))) {
            ...
            pigZombie = (PigZombie) player.getWorld().spawnEntity(player.getLocation(), EntityType.PIG_ZOMBIE);
            Utils.setNoAI(pigZombie);
    ...
    public static void detachedMobHatPigZombie(Player player) {
