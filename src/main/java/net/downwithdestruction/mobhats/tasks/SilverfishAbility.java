...
public class SilverfishAbility {
    ...
    private static Silverfish silverfish;
    ...
    public static void attachedMobHatSilverfish(Player player) {
        if ((player.hasPermission("mobhats.command.mobhat.silverfish")) || (player.hasPermission("mobhats.command.mobhat.all"))) {
    ...
    public static void detachedMobHatSilberfish(Player player) {
