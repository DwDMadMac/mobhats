...
public class SpiderAbility {
    ...
    public static void attachedMobHatSpider(Player player) {
        if ((player.hasPermission("mobhats.command.mobhat.spider")) || (player.hasPermission("mobhats.command.mobhat.all"))) {
            ...
            spider = (Spider) player.getWorld().spawnEntity(player.getLocation(), EntityType.SPIDER);
            Utils.setNoAI(spider);
    ...
    public static void detachedMobHatSpider(Player player) {
