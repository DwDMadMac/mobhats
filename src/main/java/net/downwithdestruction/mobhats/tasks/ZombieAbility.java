...
public class ZombieAbility {
    ...
    public static void attachedMobHatZombie(Player player) {
        if ((player.hasPermission("mobhats.command.mobhat.zombie")) || (player.hasPermission("mobhats.command.mobhat.all"))) {
    ...
    public static void detachedMobHatZombie(Player player) {
